...
public class TestOtro {
    ...
    public static void main(String[] args) {
        ...
        Personaje1 pers1 = new Personaje1("Gandalf", "Mago", 100, 50, 2);
        Personaje1 pers2 = new Personaje1("Conan", "Guerrero", 0, 60, 4);
        ...
        pers1.subirNivel(1,20);
        System.out.println(pers1);

        pers2.revivir();
        pers2.subirNivel(2,50);
