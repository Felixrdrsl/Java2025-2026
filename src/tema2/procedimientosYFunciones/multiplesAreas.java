    ...
    public class multiplesAreas {
        ...
        public static double area(double valor1, double valor2, String tipo) {
            switch (tipo) {
                ...
                case "Triangulo":
                    return Funciones1.areaTriangulo(valor1, valor2);
                case "Rombo":
        ...
        public static double calcAreaRombo(double diagonalM, double diagonalMN){
            return (diagonalM * diagonalMN) / 2;
        }

        public static double calcAreaHexagono(double lado, double area){
            return (lado * 6 * area)/2;
        }
        public static void main(String[] args) {
            ...
            int opcion=-1;
            double radio, lado, base, altura, diagonalM, diagomalMN;
                ...
                try {
                    ...
                    switch (opcion) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            System.out.println("Dime su diagonal mayor: ");
                            diagonalM = sc.nextDouble();
                            System.out.println("Dime su diagonal menor: ");
                            diagomalMN = sc.nextDouble();
                            System.out.println("Su area es: " + area(diagonalM, diagomalMN,"Rombo"));
                            break;
                        case 6:
                            ...
                            radio = sc.nextDouble();
                            System.out.println("Su area es: " + area(lado, radio, "Hexagono"));
                            break;
                        case 7:
