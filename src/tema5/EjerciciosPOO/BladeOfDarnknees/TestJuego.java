...
public class TestJuego {
    static void main() {
        ...
        Jugador jugador = new Jugador("Paco",TipoPersonaje.CABALLERO);

        Arma espada = new Arma("Espada",30.0,false, TipoArma.ESPADA);
        Arma hacha = new Arma("Hacha",60.0,true, TipoArma.HACHA);

        jugador.equiparArma(espada);

        ArrayList<Monstruo> monstruos = new ArrayList<>();

        Monstruo m1 = new Monstruo("Globin debil", ClaseMonstruo.GLOBIN);
        Monstruo m2 = new Monstruo("Troll", ClaseMonstruo.TROLL);
        Monstruo m3 = new Monstruo("Skrall", ClaseMonstruo.SKRALL);
        Monstruo m4 = new Monstruo("Demonio", ClaseMonstruo.DEMONIO);
